// Generated by Wrangler by running `wrangler types` (hash: 66f93b45463950982a5d2818eb5903c1)
// Runtime types generated with workerd@1.20250319.0 2025-03-12 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		OPENAI_LLM_API_URL: string;
		OPENAI_LLM_API_KEY: string;
		OpenMcpOpenAPI: DurableObjectNamespace<import("./src/index").OpenMcpOpenAPI>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_LLM_API_URL" | "OPENAI_LLM_API_KEY">> {}
}
declare module "*.json" {
	const value: string;
