// Generated by Wrangler by running `wrangler types` (hash: 2945595fb2edba07296550164eca5ba0)
// Runtime types generated with workerd@1.20250408.0 2025-04-08 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		PUBLIC_URL: "http://localhost:3001" | "https://datanaut.ai";
		...
		DB_ENC_SECRET: string;
		OPENMCP_OPENAPI: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_URL" | "OPENAI_API_KEY" | "OPENAI_API_URL" | "ANTHROPIC_API_KEY" | "ANTHROPIC_API_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "DB_ENC_SECRET">> {}
}
